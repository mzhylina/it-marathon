...
public class ProposalsController(IProposalService proposalService, IMapper mapper) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="top">Number of records to retrieve.</param>
    /// <param name="skip">Number of records to skip.</param>
    /// <param name="filter">Filter condition for the records.</param>
    /// <param name="orderby">Field to order by.</param>
    /// <returns>Paginated and filtered list of proposals.</returns>
